...
import com.codecrafters.quizquest.models.QuizQuestionNonAdmin;
...
public class QuizQuestionActivity extends AppCompatActivity {
    ...
    private ArrayList<QuizQuestionNonAdmin> quizQuestions = new ArrayList<>();
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot questionSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (questionId != null && questionId.startsWith(quizSetId + "_")) {
                        ...
                        QuizQuestionNonAdmin quizQuestion = questionSnapshot.getValue(QuizQuestionNonAdmin.class);
    ...
    private void showQuestion(int questionIndex) {
        ...
        if (questionIndex < quizQuestions.size()) {
            QuizQuestionNonAdmin quizQuestion = quizQuestions.get(questionIndex);
